...
public class ReceiveListActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle saveInstanceState) {
        ...
        url.append("?cmd=getReceiveList");
        url.append("&myNumber="+PhoneNum);

        // AsyncTask를 통해 HttpURLConnection 수행.
        ReceiveListActivity.NetworkTask networkTask = new ReceiveListActivity.NetworkTask(url.toString(), null);
        networkTask.execute();
